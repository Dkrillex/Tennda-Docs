...
description: 'TenndaAI data security measures including encryption, minimal storage, and access control'
---

## Data Security Commitment

TenndaAI takes user data security seriously with multiple protection measures. We're committed to providing secure, reliable AI services.
...
TenndaAI conducts regular security assessments:
...
<Card title="Technical Support" icon="envelope" href="mailto:bd@tennda.ai">
  **Email**: bd@tennda.ai
