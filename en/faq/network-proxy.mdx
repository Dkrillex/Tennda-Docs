...
description: 'Learn about TenndaAI network access and whether you need a proxy or VPN'
---

## Short Answer

**No proxy needed, direct connection works.** TenndaAI supports direct access from China without any proxy or VPN.
...
<Card title="Email Support" icon="envelope" href="mailto:bd@tennda.ai">
  bd@tennda.ai - Technical support, fast response
</Card>
