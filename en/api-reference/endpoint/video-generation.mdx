...
```bash
curl -X GET "https://api.tennda.ai/v1/video/generations/video_69095b4ce0048190893a01510c0c98b0" \
...
```bash
curl -X GET "https://api.tennda.ai/v1/video/generations/download?id=video_69095b4ce0048190893a01510c0c98b0" \
  -H "Authorization: Bearer sk-xxxxxxxxxx"
```
...
<Tabs>
  ...
  <Tab title="Veo Complete Example">
    ...
    **Response Example**:
    ...
    ```bash
    curl -X GET "https://api.tennda.ai/v1/video/generations/video_1234567890abcdef" \
      -H "Authorization: Bearer sk-xxxxxxxxxx"
    ```
    ...
    **Response Example (Completed)**:
    ```json
    {
      ...
      "status": "succeeded",
      "format": "mp4",
      "url": "https://tennda-ads.oss-cn-guangzhou.aliyuncs.com/2025/11/18/abc123/veo-demo-1.mp4"
    }
    ```
  ...
  <Tab title="Ali Wanxiang Complete Example">
    ...
    **Response Example**:
    ...
    ```bash
    curl -X GET "https://api.tennda.ai/v1/video/generations/ae8eb420-8aa6-440a-8eb8-1d1afe8d5e97" \
      -H "Authorization: Bearer sk-xxxxxxxxxx"
    ```
  ...
  <Tab title="Doubao Seedance Complete Example">
    ...
    **Response Example**:
    ...
    ```bash
    curl -X GET "https://api.tennda.ai/v1/video/generations/cgt-2025123456-abcd" \
      -H "Authorization: Bearer sk-xxxxxxxxxx"
    ```
...
<Tabs>
  <Tab title="Python Polling Example">
    ...
    def poll_task_status(task_id, api_key, max_wait_time=300):
        ...
        url = f"https://api.tennda.ai/v1/video/generations/{task_id}"
  ...
  <Tab title="JavaScript Polling Example">
    ...
    async function pollTaskStatus(taskId, apiKey, maxWaitTime = 300000) {
      const url = `https://api.tennda.ai/v1/video/generations/${taskId}`;
