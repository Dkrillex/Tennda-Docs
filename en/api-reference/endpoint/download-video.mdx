...
api: 'GET https://api.tennda.ai/v1/video/generations/download?id={videoId}'
---
...
const response = await fetch('https://api.tennda.ai/v1/video/generations/download?id=video_xxx', {
  headers: {
...
def download_video(video_id, api_key):
    ...
    url = f"https://api.tennda.ai/v1/video/generations/download?id={video_id}"
