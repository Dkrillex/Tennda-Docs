...
curl "https://api.tennda.ai/v1/asset-groups" \
  -H "Authorization: Bearer sk-xxxxxxxxxx"

# Live-person only
curl "https://api.tennda.ai/v1/asset-groups?group_type=liveness_face" \
  -H "Authorization: Bearer sk-xxxxxxxxxx"

# All
curl "https://api.tennda.ai/v1/asset-groups?group_type=all" \
  -H "Authorization: Bearer sk-xxxxxxxxxx"
```
