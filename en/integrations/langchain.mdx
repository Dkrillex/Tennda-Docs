...
LangChain is a powerful framework for building language model applications. By integrating with **TenndaAI**, you can flexibly call various AI models in LangChain.
...
os.environ["OPENAI_API_KEY"] = "Your TenndaAI Key"
