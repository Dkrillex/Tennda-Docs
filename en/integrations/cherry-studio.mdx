...
Cherry Studio is a powerful AI chat client that supports multiple large language models. With **TenndaAI**, you can easily use various mainstream AI models in Cherry Studio.

## Quick Integration

### 1. Get API Key

Visit [TenndaAI](https://client.tennda.ai) to get your API key.
...
4. Fill in:
   ...
   - API Key: Your key from TenndaAI console
5. Click "➕ Add" to save

<Warning>
API URL must be `https://api.tennda.ai`
</Warning>
...
<AccordionGroup>
  <Accordion title="Connection Failed">
    ...
    - Confirm API URL is `https://api.tennda.ai`
...
3. **Monitor usage**: Check usage via TenndaAI console
