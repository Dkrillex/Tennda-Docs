---
title: '原生 Claude 格式'
api: 'POST https://api.tennda.ai/v1/messages'
---
...
<Note>
如果您使用 OpenAI 兼容的客户端（如 OpenAI SDK），建议使用 [`/v1/chat/completions`](/cn/api-reference/endpoint/chat-openai) 接口。
</Note>
